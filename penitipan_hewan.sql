...
-- 2. Insert the Tier Data
INSERT INTO fasilitas (nama_fasilitas, deskripsi, harga_per_hari, icon) VALUES
('Basic', 'Kandang bersih, makan 2x sehari, area bermain standar, pembersihan harian.', 50000, '🏠'),
('Standard', 'Semua fitur Basic + Vitamin harian, grooming dasar, dan update foto harian via WhatsApp.', 80000, '🌟'),
('Premium', 'Semua fitur Standard + Ruangan ber-AC, grooming premium, dan akses CCTV 24 jam.', 120000, '👑');
